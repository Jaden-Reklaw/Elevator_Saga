{
    init: function(elevators, floors) {
        ...
        elevators.forEach((elevator, index) => {
            ...
            elevator.on("floor_button_pressed", function(floorNum) {
                //I was going to use the destination queue to find the most efficent way
                //to go to each floor by order but this program passed
                console.log('destination queue is:', elevator.destinationQueue);
                elevator.goToFloor(floorNum);
            });               
        });
    },
